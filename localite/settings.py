...
class Base(Configuration):
    ...
    LOCAL_APPS = [
        "localite.activities.apps.ActivitiesConfig",
        "localite.comments.apps.CommentsConfig",
        "localite.communities.apps.CommunitiesConfig",
        "localite.core.apps.CoreConfig",
        "localite.events.apps.EventsConfig",
        "localite.flags.apps.FlagsConfig",
        ...
        "localite.subscriptions.apps.SubscriptionsConfig",
        "localite.users.apps.UsersConfig",
    ]
    ...
    MIDDLEWARE = [
        ...
        "localite.core.turbolinks.middleware.TurbolinksMiddleware",
        "localite.communities.middleware.CurrentCommunityMiddleware",
    ...
    ACCOUNT_USER_DISPLAY = "localite.users.utils.user_display"
    ...
    MARKDOWNX_MARKDOWNIFY_FUNCTION = (
        "localite.core.markdown.utils.markdownify"
    )

    # https://micawber.readthedocs.io/en/latest/django.html
    MICAWBER_PROVIDERS = "localite.activities.oembed.bootstrap_oembed"
...
class Production(DockerConfigMixin, Base):
    ...
    DEFAULT_FILE_STORAGE = "localite.core.storages.MediaStorage"
    STATICFILES_STORAGE = "localite.core.storages.StaticStorage"
