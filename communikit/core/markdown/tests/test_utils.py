...
from communikit.core.markdown.utils import (
    extract_mentions,
    linkify_hashtags,
    linkify_mentions,
    markdownify,
...
class TestLinkifyMentions:
    def test_linkify(self):
        ...
        assert replaced == 'hello <a href="/users/danjac/">@danjac</a>'
...
class TestLinkifyHashtags:
    def test_linkify(self):
        ...
        assert (
            replaced == 'tags: <a href="/search/?q=%23coding">#coding</a>'
            ' <a href="/search/?q=%23opensource">#opensource</a>'
            ' <a href="/search/?q=%23coding2019">#coding2019</a>'
        )
