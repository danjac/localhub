...
class Base(Configuration):
    ...
    LOCAL_APPS = [
        "bfg.apps.activities.apps.ActivitiesConfig",
        "bfg.apps.bookmarks.apps.BookmarksConfig",
        "bfg.apps.comments.apps.CommentsConfig",
        "bfg.apps.communities.apps.CommunitiesConfig",
        "bfg.apps.events.apps.EventsConfig",
        "bfg.apps.flags.apps.FlagsConfig",
        "bfg.apps.hashtags.apps.HashtagsConfig",
        "bfg.apps.invites.apps.InvitesConfig",
        "bfg.apps.join_requests.apps.JoinRequestsConfig",
        "bfg.apps.likes.apps.LikesConfig",
        "bfg.apps.notifications.apps.NotificationsConfig",
        "bfg.apps.photos.apps.PhotosConfig",
        "bfg.apps.polls.apps.PollsConfig",
        "bfg.apps.posts.apps.PostsConfig",
        "bfg.apps.private_messages.apps.PrivateMessagesConfig",
        "bfg.apps.users.apps.UsersConfig",
    ]
    ...
    MIDDLEWARE = [
        ...
        "bfg.middleware.turbolinks.TurbolinksMiddleware",
        "bfg.apps.communities.middleware.CurrentCommunityMiddleware",
    ...
    ACCOUNT_USER_DISPLAY = "bfg.apps.users.utils.user_display"
    ...
    SOCIALACCOUNT_ADAPTER = "bfg.apps.users.adapters.SocialAccountAdapter"
    ...
    MARKDOWNX_MARKDOWNIFY_FUNCTION = "bfg.markdown.utils.markdownify"

    MARKDOWNX_MARKDOWN_EXTENSIONS = [
        "pymdownx.extra",
        "pymdownx.emoji",
        "bfg.markdown.extensions:NewTabExtension",
        "bfg.markdown.extensions:SafeImageExtension",
    ]
    ...
    MICAWBER_PROVIDERS = "bfg.apps.activities.oembed.bootstrap_oembed"
    ...
    BFG_GEOLOCATOR_USER_AGENT = values.Value("bfg.locator")
        ...
        return [
            {
                ...
                "OPTIONS": {
                    "debug": self.DEBUG,
                    "builtins": [
                        "bfg.template.defaultfilters",
                        "bfg.template.defaulttags",
                    ],
                    "context_processors": [
                        ...
                        "bfg.apps.communities.context_processors.community",
                        "bfg.template.context_processors.home_page_url",
                    ],
                    "libraries": {"pagination": "bfg.pagination.templatetags"},
                },
            }
        ]
...
class Production(Base):
    ...
    DEFAULT_FILE_STORAGE = "bfg.storages.MediaStorage"
    STATICFILES_STORAGE = "bfg.storages.StaticStorage"
    ...
    MIDDLEWARE = Base.MIDDLEWARE + [
        "bfg.middleware.http.HttpResponseNotAllowedMiddleware",
        "silk.middleware.SilkyMiddleware",
    ]
