...
from bfg.apps.comments.factories import CommentFactory
from bfg.apps.communities.factories import CommunityFactory, MembershipFactory
from bfg.apps.communities.models import Membership
from bfg.apps.events.factories import EventFactory
from bfg.apps.invites.factories import InviteFactory
from bfg.apps.join_requests.factories import JoinRequestFactory
from bfg.apps.likes.factories import LikeFactory
from bfg.apps.notifications.factories import NotificationFactory
from bfg.apps.photos.factories import PhotoFactory
from bfg.apps.polls.factories import PollFactory
from bfg.apps.posts.factories import PostFactory
from bfg.apps.private_messages.factories import MessageFactory
...
def send_webpush_mock(mocker):
    return mocker.patch("bfg.apps.notifications.tasks.send_webpush")
