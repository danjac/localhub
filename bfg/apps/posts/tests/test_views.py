...
from bfg.apps.bookmarks.factories import BookmarkFactory
from bfg.apps.bookmarks.models import Bookmark
from bfg.apps.comments.models import Comment
from bfg.apps.communities.factories import MembershipFactory
from bfg.apps.communities.models import Membership
from bfg.apps.flags.models import Flag
...
class TestPostDeleteView:
    ...
    def test_post(self, client, post_for_member):
        ...
        assert response.url == settings.BFG_HOME_PAGE_URL
