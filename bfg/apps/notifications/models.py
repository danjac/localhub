...
class PushSubscription(models.Model):
    ...
    def push(self, payload, ttl=0):
        ...
        vapid_creds = {}
        if settings.BFG_VAPID_PRIVATE_KEY:
            vapid_creds["vapid_private_key"] = settings.BFG_VAPID_PRIVATE_KEY
        if settings.BFG_VAPID_ADMIN_EMAIL:
            vapid_creds["vapid_claims"] = {
                "sub": f"mailto:{settings.BFG_VAPID_ADMIN_EMAIL}"
            }
