...
from bfg.apps.events.models import Event
from bfg.apps.flags.factories import FlagFactory
from bfg.apps.likes.factories import LikeFactory
from bfg.apps.notifications.factories import NotificationFactory
from bfg.apps.photos.models import Photo
from bfg.apps.posts.factories import PostFactory
from bfg.apps.posts.models import Post
