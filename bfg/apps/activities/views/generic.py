...
from bfg.apps.bookmarks.models import Bookmark
from bfg.apps.comments.forms import CommentForm
from bfg.apps.communities.views import CommunityRequiredMixin
from bfg.apps.flags.forms import FlagForm
from bfg.apps.likes.models import Like
from bfg.pagination import PresetCountPaginator
from bfg.template.defaultfilters import resolve_url
...
class ActivityDeleteView(
    ...
    def get_success_url(self):
        if self.object.deleted or self.object.published:
            return settings.BFG_HOME_PAGE_URL
