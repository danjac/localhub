...
from bfg.apps.bookmarks.models import Bookmark, BookmarkAnnotationsQuerySetMixin
from bfg.apps.comments.models import Comment, CommentAnnotationsQuerySetMixin
from bfg.apps.communities.models import Community
from bfg.apps.flags.models import Flag, FlagAnnotationsQuerySetMixin
from bfg.apps.hashtags.fields import HashtagsField
from bfg.apps.hashtags.utils import extract_hashtags
from bfg.apps.likes.models import Like, LikeAnnotationsQuerySetMixin
from bfg.apps.notifications.decorators import notify
from bfg.apps.notifications.models import (
    Notification,
    NotificationAnnotationsQuerySetMixin,
)
from bfg.apps.users.fields import MentionsField
from bfg.apps.users.utils import extract_mentions
from bfg.db.generic import AbstractGenericRelation, get_generic_related_queryset
from bfg.db.search.mixins import SearchQuerySetMixin
from bfg.db.tracker import TrackerModelMixin
from bfg.db.utils import boolean_value
from bfg.markdown.fields import MarkdownField
from bfg.utils.itertools import takefirst
...
class Activity(TrackerModelMixin, TimeStampedModel):
    ...
    def resolve_url(self, view_name, *args):
        ...
        See bfg.apps.activities/urls/generic.py for list of common
        activity actions.
