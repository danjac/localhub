...
from bfg.apps.activities.utils import get_activity_models
from bfg.apps.activities.views.streams import BaseActivityStreamView
from bfg.apps.comments.models import Comment
from bfg.apps.comments.views import BaseCommentListView
from bfg.apps.communities.models import Membership
from bfg.apps.communities.views import CommunityRequiredMixin
from bfg.apps.likes.models import Like
from bfg.apps.private_messages.models import Message
from bfg.views import (
    ParentObjectMixin,
    SearchMixin,
    SuccessActionView,
    SuccessUpdateView,
...
class UserMessageListView(SingleUserMixin, ListView):
    ...
    paginate_by = settings.BFG_DEFAULT_PAGE_SIZE
...
class BaseUserListView(UserQuerySetMixin, ListView):
    paginate_by = settings.BFG_LONG_PAGE_SIZE
...
class UserAutocompleteListView(BaseUserListView):
    ...
    def get_queryset(self):
        ...
        if search_term:
            ...
            )[: settings.BFG_DEFAULT_PAGE_SIZE]
        return qs.none()
...
class UserDeleteView(CurrentUserMixin, PermissionRequiredMixin, DeleteView):
    ...
    success_url = settings.BFG_HOME_PAGE_URL
