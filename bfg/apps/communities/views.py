...
from bfg.apps.invites.models import Invite
from bfg.apps.join_requests.models import JoinRequest
from bfg.views import SearchMixin, SuccessDeleteView, SuccessUpdateView
...
class CommunityWelcomeView(BaseCommunityDetailView):
    ...
    def get(self, request):
        if rules.test_rule("communities.is_member", request.user, request.community):
            return HttpResponseRedirect(settings.BFG_HOME_PAGE_URL)
