...
LOCALHUB_VAPID_PUBLIC_KEY = env.str("VAPID_PUBLIC_KEY")
LOCALHUB_VAPID_PRIVATE_KEY = env.str("VAPID_PRIVATE_KEY")
LOCALHUB_VAPID_ADMIN_EMAIL = env.str("VAPID_ADMIN_EMAIL")
