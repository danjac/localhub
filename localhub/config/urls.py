...
urlpatterns = [
    ...
    path("events/", include("localhub.activities.events.urls")),
    ...
    path("photos/", include("localhub.activities.photos.urls")),
    path("polls/", include("localhub.activities.polls.urls")),
    path("posts/", include("localhub.activities.posts.urls")),
