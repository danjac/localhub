    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='reshares', to='polls.Poll')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='polls.Poll')),
            ],
            options={
        ...
        migrations.AddIndex(
            model_name='poll',
            index=django.contrib.postgres.indexes.GinIndex(fields=['search_document'], name='polls_poll_search__666b21_gin'),
        ),
        migrations.AddIndex(
            model_name='poll',
            index=models.Index(fields=['created', '-created'], name='polls_poll_created_b81dd9_idx'),
        ),
    ]
