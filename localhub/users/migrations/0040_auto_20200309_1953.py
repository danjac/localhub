    ...
    operations = [
        migrations.AddField(
            ...
            field=models.BooleanField(
                default=True,
                verbose_name="Send me an email when I receive a new Direct Message",
            ),
        ),
        migrations.AddField(
            model_name="user",
            ...
            field=models.BooleanField(
                default=True,
                help_text="You can filter which Notifications you receive under the Notification preferences list.",
                verbose_name="Send me an email when I receive a new Notification",
            ),
        ),
        migrations.AddField(
            model_name="user",
            ...
            field=models.BooleanField(
                default=True,
                help_text="To enable browser notifications, click 'Enable browser notifications' under Notifications. Your browser and device must also be granted permission to display notifications.",
                verbose_name="Show a browser notification when I receive a new Direct Message",
            ),
        ),
        migrations.AddField(
            model_name="user",
            ...
            field=models.BooleanField(
                default=True,
                help_text="You can filter which Notifications you receive under the Notification preferences list. To enable browser notifications, click 'Enable browser notifications' under Notifications. Your browser and device must also be granted permission to display notifications.",
                verbose_name="Send me a browser notification when I receive a new Notification",
            ),
        ),
