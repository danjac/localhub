...
from ..html_parser import parse_metadata_from_html, parse_metadata_from_url


class TestParseMetadataFromUrl:
...
<body>
    ...
    def test_if_no_url(self):
        title, image, description = parse_metadata_from_url(None)
        assert (title, image, description) == (None, None, None)


class TestParseMetadataFromHtml:
    def test_parse_title_in_meta(self):
        ...
        """
        title, _, _ = parse_metadata_from_html(html)
    ...
    def test_image_in_meta(self):
        ...
        """
        _, image, _ = parse_metadata_from_html(html)
    ...
    def test_description_in_meta(self):
        ...
        """
        _, _, description = parse_metadata_from_html(html)
