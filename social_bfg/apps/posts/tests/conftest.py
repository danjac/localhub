...
def mock_url_resolver(mocker):
    ...
    mocker.patch(
        "social_bfg.common.utils.http.URLResolver.from_url", return_value=resolver
    )
...
def mock_html_scraper_from_url(mocker):
    ...
    mocker.patch(
        "social_bfg.common.utils.scraper.HTMLScraper.from_url", return_value=scraper
    )
    yield
...
def mock_html_scraper_from_invalid_url(mocker):
    mocker.patch(
        "social_bfg.common.utils.scraper.HTMLScraper.from_url",
