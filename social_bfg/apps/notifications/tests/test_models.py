...
class TestPushSubscriptionModel:
    def test_push_if_ok(self, member):
        ...
        with mock.patch("social_bfg.apps.notifications.models.webpush") as mock_webpush:
            sub.push(payload)
    ...
    def test_push_if_timeout(self, member):
        ...
        with mock.patch("social_bfg.apps.notifications.models.webpush", side_effect=e):
