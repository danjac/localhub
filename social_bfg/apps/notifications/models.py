...
class PushSubscription(models.Model):
    ...
    def push(self, payload, ttl=0):
        ...
        vapid_creds = {}
        if settings.SOCIAL_BFG_VAPID_PRIVATE_KEY:
            vapid_creds["vapid_private_key"] = settings.SOCIAL_BFG_VAPID_PRIVATE_KEY
        if settings.SOCIAL_BFG_VAPID_ADMIN_EMAIL:
            vapid_creds["vapid_claims"] = {
                "sub": f"mailto:{settings.SOCIAL_BFG_VAPID_ADMIN_EMAIL}"
            }
