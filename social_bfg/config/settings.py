...
class Base(Configuration):
    ...
    def STATICFILES_DIRS(self):
        return [
            ...
            # assets generated by vue build process
            # pipeline should first build these assets with vue/webpack
            # then collectstatic will just push to s3
        ...
        return [
            {
                ...
                "DIRS": [
                    # Django templates for emails, non-vue pages etc
                    os.path.join(self.BASE_DIR, "templates"),
                    # templates generated by vue build process
